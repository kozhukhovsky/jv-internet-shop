                            ...
                            <c:forEach var="item" items="${items}">
                                <tr>
                                    ...
                                    <td><a class="button is-danger"
                                           href="${pageContext.request.contextPath}/servlet/admin/deleteItem?item_id=${item.id}">
                                        Delete</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    <form action="${pageContext.request.contextPath}/servlet/admin/createItem" method="post">
