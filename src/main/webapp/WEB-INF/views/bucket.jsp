                            ...
                            <c:forEach var="item" items="${items}">
                                <tr>
                                    ...
                                    <td><a class="button is-fullwidth is-small is-primary is-rounded"
                                           href="${pageContext.request.contextPath}/servlet/removeItemFromBucket?item_id=${item.id}">
                                        Remove</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    <a class="button is-primary" href="${pageContext.request.contextPath}/servlet/completeOrder">Complete Order</a><br>
                </div>
            </div>
        </section>
    </body>
